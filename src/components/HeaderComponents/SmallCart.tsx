...
export function SmallCart(props: SmallCartProps) {
  ...
  function smallCartRemove(id: number) {
  ...
  return (
    <div className="small-cart">
      ...
      <div className={`small-cart__open ${!smallCartOpen ? 'hidden' : ''}`}>
        <div className="small-cart__open-item">
          <img className="small-cart__open-item--img" src="" alt="product" />

          <div className="small-cart__open-item--data">
            <p className="small-cart__open-item--data__name">Some product</p>
            
            <div className="small-cart__open-item--data__price">
              <p className="small-cart__open-item--data__price--price">$98</p>
              <p className="small-cart__open-item--data__price--cents">21</p>
            </div>

            <p className="small-cart__open-item--data__quantity">2</p>
          </div>

          <button className="small-cart__open-item--remove-btn">
